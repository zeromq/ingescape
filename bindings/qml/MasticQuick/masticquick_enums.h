...
/**
  ...
  */
MASTIC_QML_ENUM_CUSTOM(MasticIopType, INVALID = 0, INTEGER, DOUBLE, STRING, BOOLEAN, IMPULSION, DATA)
 ...
 */
MASTIC_QML_ENUM_CUSTOM(MasticLogLevel, LOG_TRACE = 0, LOG_DEBUG, LOG_INFO, LOG_WARN, LOG_ERROR, LOG_FATAL)
