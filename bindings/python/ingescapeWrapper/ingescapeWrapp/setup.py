...
src = ["ingescapePython.c", "admin.c", "data.c", "definition.c", "mapping.c", "freezecallback.c", "init.c", "input.c", "observecallback.c", "output.c", "parameter.c", "start.c", "stopcallback.c", "advanced.c"]
