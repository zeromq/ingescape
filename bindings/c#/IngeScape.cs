...
namespace WinFormsSimpleAgent
{
    ...
    class IngeScape
    {
        ...
        [DllImport("C:\\ingescape\\lib\\debug\\ingescape.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
  ...
  //      [DllImport("C:\\ingescape\\lib\\debug\\ingescape.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		//public static extern void igs_observeForcedStop(igs_forcedStopCallback cb, void* myData);
  ...
  //      [DllImport("C:\\ingescape\\lib\\debug\\ingescape.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        //TODO : implement it
  //      [DllImport("C:\\ingescape\\lib\\debug\\ingescape.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		//public static extern int igs_createInput([MarshalAs(UnmanagedType.LPStr)]  string name, iopType_t value_type, void* value, long size); //value must be copied in function
  //      [DllImport("C:\\ingescape\\lib\\debug\\ingescape.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		//public static extern int igs_createOutput([MarshalAs(UnmanagedType.LPStr)]  string name, iopType_t type, void* value, long size); //value must be copied in function
  //      [DllImport("C:\\ingescape\\lib\\debug\\ingescape.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		//public static extern int igs_createParameter([MarshalAs(UnmanagedType.LPStr)]  string name, iopType_t type, void* value, long size); //value must be copied in function
