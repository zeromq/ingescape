...
export class Agent {
    ...
    inputSetDescription(name:string, description:string):number;
    inputDescription(name:string):string;
    outputSetDescription(name:string, description:string):number;
    outputDescription(name:string):string;
    attributeSetDescription(name:string, description:string):number;
    attributeDescription(name:string):string;
    parameterSetDescription(name:string, description:string):number;
    ...
    serviceSetDescription(name:string, description:string):number;
    serviceDescription(name:string):string;
    ...
    serviceArgSetDescription(serviceName:string, argName:string, description:string):number;
    serviceArgDescription(serviceName:string, argName:string):string;
    serviceReplyAdd(serviceName:string, replyName:string):number;
    serviceReplyRemove(serviceName:string, replyName:string):number;
    serviceReplySetDescription(serviceName:string, replyName:string, description:string):number;
    serviceReplyDescription(serviceName:string, replyName:string):string;
    ...
    serviceReplyArgSetDescription(serviceName:string, replyName:string, argName:string, description:string):number;
    serviceReplyArgDescription(serviceName:string, replyName:string, argName:string):string;
    serviceCount():number;
...
export function inputSetDescription(name:string, description:string):number;
export function inputDescription(name:string):string;
export function outputSetDescription(name:string, description:string):number;
export function outputDescription(name:string):string;
export function attributeSetDescription(name:string, description:string):number;
export function attributeDescription(name:string):string;
export function parameterSetDescription(name:string, description:string):number;
...
export function serviceSetDescription(name:string, description:string):number;
...
export function serviceArgSetDescription(serviceName:string, argName:string, description:string):number;
export function serviceArgDescription(serviceName:string, argName:string):string;
export function serviceReplyAdd(serviceName:string, replyName:string):number;
export function serviceReplyRemove(serviceName:string, replyName:string):number;
export function serviceReplySetDescription(serviceName:string, replyName:string, description:string):number;
export function serviceReplyDescription(serviceName:string, replyName:string):string;
export function serviceReplyArgAdd(serviceName:string, replyName:string, argName:string, type:number):number;
export function serviceReplyArgRemove(serviceName:string, replyName:string, argName:string):number;
export function serviceReplyArgSetDescription(serviceName:string, replyName:string, argName:string, description:string):number;
export function serviceReplyArgDescription(serviceName:string, replyName:string, argName:string):string;
...
export function serviceArgExists(serviceName:string, argumentName:string):boolean;
export function serviceHasReplies(serviceName:string):boolean;
export function serviceHasReply(serviceName:string, replyName:string):boolean;
export function serviceReplyNames(serviceName:string):string[];
export function serviceReplyArgsList(serviceName:string, replyName:string):Object[];
export function serviceReplyArgsCount(serviceName:string, replyName:string):number;
export function serviceReplyArgExists(serviceName:string, replyName:string, argName:string):number;
