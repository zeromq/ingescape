...
extern "C" {
    ...
    typedef struct igsyajl_gen igsyajl_gen_t;
     ...
     */
    IGSYAJL_API int igsyajl_gen_config(igsyajl_gen_t *g, igsyajl_gen_option opt, ...);
     ...
     */
    IGSYAJL_API igsyajl_gen_t* igsyajl_gen_alloc(const igsyajl_alloc_funcs * allocFuncs);

    /** free a generator handle */
    IGSYAJL_API void igsyajl_gen_free(igsyajl_gen_t *handle);

    IGSYAJL_API igsyajl_gen_status igsyajl_gen_integer(igsyajl_gen_t *hand, long long int number);
    /** generate a floating point number.  number may not be infinity or
     *  NaN, as these have no representation in JSON.  In these cases the
     *  generator will return 'igsyajl_gen_invalid_number' */
    IGSYAJL_API igsyajl_gen_status igsyajl_gen_double(igsyajl_gen_t *hand, double number);
    IGSYAJL_API igsyajl_gen_status igsyajl_gen_number(igsyajl_gen_t *hand,
                                                      const char * num,
                                                      size_t len);
    IGSYAJL_API igsyajl_gen_status igsyajl_gen_string(igsyajl_gen_t *hand,
                                                      const unsigned char * str,
                                                      size_t len);
    IGSYAJL_API igsyajl_gen_status igsyajl_gen_null(igsyajl_gen_t *hand);
    IGSYAJL_API igsyajl_gen_status igsyajl_gen_bool(igsyajl_gen_t *hand, int boolean);
    IGSYAJL_API igsyajl_gen_status igsyajl_gen_map_open(igsyajl_gen_t *hand);
    IGSYAJL_API igsyajl_gen_status igsyajl_gen_map_close(igsyajl_gen_t *hand);
    IGSYAJL_API igsyajl_gen_status igsyajl_gen_array_open(igsyajl_gen_t *hand);
    IGSYAJL_API igsyajl_gen_status igsyajl_gen_array_close(igsyajl_gen_t *hand);

    /** access the null terminated generator buffer.  If incrementally
     *  outputing JSON, one should call igsyajl_gen_clear to clear the
     *  buffer.  This allows stream generation. */
    IGSYAJL_API igsyajl_gen_status igsyajl_gen_get_buf(igsyajl_gen_t *hand,
    ...
    IGSYAJL_API void igsyajl_gen_clear(igsyajl_gen_t *hand);
    ...
    IGSYAJL_API void igsyajl_gen_reset(igsyajl_gen_t *hand, const char * sep);
