...
ApplicationWindow {
    ...
    title: qsTr("IngeScape Expe - v%1").arg(Qt.application.version)


    // Default size
    width: IngeScapeExpeTheme.appMinWidth // IngeScapeExpeTheme.appDefaultWidth
    height: IngeScapeExpeTheme.appMinHeight // IngeScapeExpeTheme.appDefaultHeight

    // Minimum size
    minimumWidth: IngeScapeExpeTheme.appMinWidth
    minimumHeight: IngeScapeExpeTheme.appMinHeight
    ...
    menuBar: MenuBar {
        ...
        Menu {
            ...
            /*MenuItem {
                ...
                onTriggered: {
                    IngeScapeExpeC.clearCurrentPlatform();
                }
            }
            ...
            MenuItem {
                ...
                onTriggered: {
                    IngeScapeExpeC.loadPlatformFromSelectedFile();
                }
            }
            ...
            MenuItem {
                ...
                onTriggered: {
                    IngeScapeExpeC.savePlatformToSelectedFile();
                }
            }*/
            ...
            MenuItem {
                ...
                onTriggered: {
                    I2SnapshotHelper.saveWindowOfItem(content, Qt.size(0,0), "IngeScape-Expe");
                }
            }
        }
        ...
        /*Menu {
            ...
            Instantiator {
                ...
                model: 0 // IngeScapeExpeC.openedWindows
    ...
    onClosing: {
        ...
        IngeScapeExpeC.processBeforeClosing();
    }
    ...
    Item {
        ...
        PauseAnimation {
            ...
            onStopped: {
                // Init controller
                IngeScapeExpeC.forceCreation();

                // Set the directory used to store snasphots of our application
                I2SnapshotHelper.directory = IngeScapeExpeC.snapshotDirectory;

                // Binding to display our application loader
                applicationLoader.visible = Qt.binding(function() {
                    return ((applicationLoader.status === Loader.Ready) && (IngeScapeExpeC.modelManager !== null));
                });

                /*subWindowsInstantiator.model = Qt.binding(function() {
                    return IngeScapeExpeC.openedWindows;
                });*/

                // Load our QML UI
                applicationLoader.source = "IngeScapeExpe.qml";
            }
        }
