...
if (CMAKE_CROSSCOMPILING)
    if ("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "arm")
        if ("${CMAKE_SYSTEM_NAME}" STREQUAL "Android")
            set(CMAKE_OS_NAME "Android" CACHE STRING "Operating system name" FORCE)
            set(CMAKE_OS_VERSION "${CMAKE_SYSTEM_VERSION}")
        elseif ("${CMAKE_SYSTEM_NAME}" STREQUAL "Linux")
            set(CMAKE_OS_NAME "Linux_armhf" CACHE STRING "Operating system name" FORCE)
            set(CMAKE_OS_VERSION "unknown")
        endif ()
    endif ()
elseif (UNIX)
    if (APPLE)
