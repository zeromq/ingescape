...
macro(get_ingescape_version _MAJOR _MINOR _PATCH)
    ...
    if (${CI_PIPELINE_ID})
        if (APPLE)
            math(EXPR moduloed_pipeline_id1 "${CI_PIPELINE_ID} / 1024" OUTPUT_FORMAT DECIMAL)
            math(EXPR moduloed_pipeline_id2 "${CI_PIPELINE_ID} % 1024" OUTPUT_FORMAT DECIMAL)
        ...
        if (APPLE)
            math(EXPR moduloed_pipeline_id1 "${CMAKE_MATCH_1} / 1024" OUTPUT_FORMAT DECIMAL)
            math(EXPR moduloed_pipeline_id2 "${CMAKE_MATCH_1} % 1024" OUTPUT_FORMAT DECIMAL)
            set(${_PATCH} "${moduloed_pipeline_id1}.${moduloed_pipeline_id2}")
        else(APPLE)
