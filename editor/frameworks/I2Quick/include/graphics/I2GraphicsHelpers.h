...
#ifndef _I2GRAPHICSHELPERS_
#define _I2GRAPHICSHELPERS_
...
//--------------------------------------------------------
//
// Qt5 Helper functions
//
// The code underneath is from the QSVG module
// (qtsvg/src/svg/qsvghandler.cpp file)
//--------------------------------------------------------
...
class I2QUICK_EXPORT I2GraphicsHelpers {
...
public:
    ...
    static QVector<qreal> parseNumbersList(const QString &stringNumbersList)
    {
        QVector<qreal> points;
        if (!stringNumbersList.isEmpty())
        {
            const QChar *str = stringNumbersList.constData();
...
//--------------------------------------------------------
//
// Ingenuity i/o additions
//
//--------------------------------------------------------


    /**
     * @brief Convert an SVG path into a QPainterPath
     * @param svgPath
     * @return
     */
    static QPainterPath convertSVGPath(const QString svgPath)
    {
        QPainterPath result;
