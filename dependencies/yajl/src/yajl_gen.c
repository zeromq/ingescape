...
int
igsyajl_gen_config(igsyajl_gen g, igsyajl_gen_option opt, ...)
{
    int rv = 1;
    va_list ap;
    va_start(ap, opt);
...
igsyajl_gen_alloc(const igsyajl_alloc_funcs * afs)
{
    ...
    g = (igsyajl_gen) YA_MALLOC(afs, sizeof(struct igsyajl_gen_t));
    if (!g) return NULL;

    memset((void *) g, 0, sizeof(struct igsyajl_gen_t));
...
void
igsyajl_gen_reset(igsyajl_gen g, const char * sep)
{
    g->depth = 0;
...
void
igsyajl_gen_free(igsyajl_gen g)
{
...
igsyajl_gen_status
igsyajl_gen_integer(igsyajl_gen g, long long int number)
{
    char i[32];
...
igsyajl_gen_status
igsyajl_gen_double(igsyajl_gen g, double number)
{
    char i[32];
...
igsyajl_gen_status
igsyajl_gen_number(igsyajl_gen g, const char * s, size_t l)
{
    ENSURE_VALID_STATE; ENSURE_NOT_KEY; INSERT_SEP; INSERT_WHITESPACE;
    g->print(g->ctx, s, l);
    APPENDED_ATOM;
...
igsyajl_gen_status
igsyajl_gen_string(igsyajl_gen g, const unsigned char * str,
                size_t len)
{
...
igsyajl_gen_status
igsyajl_gen_null(igsyajl_gen g)
{
    ENSURE_VALID_STATE; ENSURE_NOT_KEY; INSERT_SEP; INSERT_WHITESPACE;
...
igsyajl_gen_status
igsyajl_gen_bool(igsyajl_gen g, int boolean)
{
...
igsyajl_gen_status
igsyajl_gen_map_open(igsyajl_gen g)
{
    ENSURE_VALID_STATE; ENSURE_NOT_KEY; INSERT_SEP; INSERT_WHITESPACE;
    INCREMENT_DEPTH;
...
igsyajl_gen_status
igsyajl_gen_map_close(igsyajl_gen g)
{
    ENSURE_VALID_STATE;
    DECREMENT_DEPTH;
...
igsyajl_gen_status
igsyajl_gen_array_open(igsyajl_gen g)
{
    ENSURE_VALID_STATE; ENSURE_NOT_KEY; INSERT_SEP; INSERT_WHITESPACE;
    INCREMENT_DEPTH;
...
igsyajl_gen_status
igsyajl_gen_array_close(igsyajl_gen g)
{
    ENSURE_VALID_STATE;
    DECREMENT_DEPTH;
    if ((g->flags & igsyajl_gen_beautify)) g->print(g->ctx, "\n", 1);
...
igsyajl_gen_status
igsyajl_gen_get_buf(igsyajl_gen g, const unsigned char ** buf,
                 size_t * len)
{
...
void
igsyajl_gen_clear(igsyajl_gen g)
{
